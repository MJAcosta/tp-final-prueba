...
<form action="frontController?accion=insert"method="post">
    ...
    <div class="row justify-content-center mb-3 me-0 ms-0">
      <div class="col-6">
        <div>
          <input type="email" class="form-control" id="inputCorreo" aria-describedby="emailHelp" placeholder="Correo">
        </div>
      </div>
    </div>
    ...
    <div class="row justify-content-center me-0 ms-0 m-0">
      <div class="col-3 m-2">
        <button id="borrar" type="button" class="btn text-light botonBorrar">Borrar</button>
      </div>

      <div class="col-3 m-2">
        <button id="resumen" type="button" class="btn text-light botonResumen">Resumen</button>
      </div>
    </div>
</form>
  <div class="row m-0">
